...
namespace BaddiesWithItems
{
    public static class Configuration
    {
        ...
        public static void Init(ConfigFile config)
        {
            ...
            Tier1SSCPower = config.Bind("Item Generation", "Tier 1 Stage Clear Cound Power", 2f, "Power (exponent) of stage clear count for Tier 1. Used when calculating max number of items that will be given per item of that tier.");
            Tier2SSCPower = config.Bind("Item Generation", "Tier 2 Stage Clear Cound Power", 1.8f, "Power (exponent) of stage clear count for Tier 2. Used when calculating max number of items that will be given per item of that tier.");
            Tier3SSCPower = config.Bind("Item Generation", "Tier 3 Stage Clear Cound Power", 1.5f, "Power (exponent) of stage clear count for Tier 3. Used when calculating max number of items that will be given per item of that tier.");
            TierBossSSCPower = config.Bind("Item Generation", "Tier Boss Stage Clear Cound Power", 1.3f, "Power (exponent) of stage clear count for Tier Boss. Used when calculating max number of items that will be given per item of that tier.");
            TierLunarSSCPower = config.Bind("Item Generation", "Tier Lunar Stage Clear Cound Power", 1.1f, "Power (exponent) of stage clear count for Tier Lunar. Used when calculating max number of items that will be given per item of that tier.");
            TierVoidSSCPower = config.Bind("Item Generation", "Tier Void Stage Clear Cound Power", 1f, "Power (exponent) of stage clear count for Tier Void. Used when calculating max number of items that will be given per item of that tier.");
            TierFoodSSCPower = config.Bind("Item Generation", "Tier Food Stage Clear Cound Power", 1f, "Power (exponent) of stage clear count for Tier Food. Used when calculating max number of items that will be given per item of that tier.");
